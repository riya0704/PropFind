  ...
  return (
    <section className="relative pt-16">
      <div className="container">
        <div className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center rounded-3xl overflow-hidden">
          <Image
       ...
       <div className="container relative z-20 mt-[-80px] w-full max-w-6xl px-4">
        <PropertySearchForm />
      </div>
    </section>
  );
